<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        <!-- <image class="loading-bg" resize="contain" src="http://doc.zwwill.com/yanxuan/imgs/yxbox-bg.png?v5"/> -->
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">找</text>
            <text ref="lTxt2" class="l-txt l-txt-2">配</text>
            <text ref="lTxt3" class="l-txt l-txt-3">件</text>
            <text ref="lTxt4" class="l-txt l-txt-4">没</text>
            <text ref="lTxt5" class="l-txt l-txt-5">那</text>
            <text ref="lTxt6" class="l-txt l-txt-6">么</text>
            <text ref="lTxt7" class="l-txt l-txt-7">难</text>
            <text ref="lTxt8" class="l-txt l-txt-8">！</text>
        </div>
    </refresh>
</template>
<style scoped>
